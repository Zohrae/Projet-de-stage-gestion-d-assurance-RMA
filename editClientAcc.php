<?php
    ...
    $requete="select * from compteclient where id_client = $id";
    
    $result=$pdo->query($requete);
    $compteclient=$result->fetch();
    $Username=$compteclient['Username'];
    $Email=$compteclient['Email_Client'];
...
<img src="../theme/images/icooons/modifi.png" class="col-md-30 col-md-offset-10" width="50">
    ...
    <div class="container">
        <div class="panel panel-p fromthetop col-md-6 col-md-offset-3">
            ...
            <form method="post" action="changingcompteclient.php" class="form">
            <div class="form-group">
                    ...
                    <a style="color: d#069fe0;" href="editPWDClient.php">&nbsp; &nbsp; 
