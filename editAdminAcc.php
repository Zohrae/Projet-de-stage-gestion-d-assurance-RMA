<?php
    ...
    $requete="select * from responsable where Id_Responsable = $id";
    
    $result=$pdo->query($requete);
    $responsable=$result->fetch();
    $Username=$responsable['Nom_Utilisateur'];
    $Email=$responsable['Email_Admin'];
...
<img src="../theme/images/icooons/modifi.png" class="col-md-30 col-md-offset-10" width="50">
    <a style="text-shadow: black; font-size: 130%; color:darkslateblue" href="../theme/client.php"> 
        Accueil </a>
    ...
    <div class="container">
        <div class="panel panel-p fromthetop col-md-6 col-md-offset-3">
            ...
            <form method="post" action="changingresponsable.php" class="form">
            <div class="form-group">
                    ...
                    <a style="color: d#069fe0;" href="editPWDAdmin.php">&nbsp; &nbsp; 
